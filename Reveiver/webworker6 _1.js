...
this.onmessage = function(event) {
	var id = "ws://169.254.10.225:7880"; //169.254.10.225 169.254.10.66
	var id2 = "192.168.1.134";
	var id3 = "ws://127.0.0.1:4649/Echo?name=pengbo";
	var that = this;
	var pcmArray = [];
	var signal = [];
	var pcmsocket = new WebSocket("ws://" + location.hostname + ":7880"); //"ws://" + id3 + ":7880" "ws://"+id+":7880"  "ws://127.0.0.1:4649/Echo?name=pengbo"  

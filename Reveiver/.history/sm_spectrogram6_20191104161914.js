        ...
        if (this.axis ==="Horizontal") {
            ...
            if(drawData.length > (this.canvas.width * 0.8)){
                ...
                if (this.drawIndex > parseInt(this.canvas.width * 0.8)) {
                    ...
                    this.ctx.putImageData(img, parseInt(this.canvas.height * 0.1), parseInt(this.canvas.width*0.1));
                    this.allData.shift();
					// 清除Y坐标数值，重新绘制数据
            ...
            if(drawData.length > (this.canvas.width * 0.8)){
                ...
                if (this.drawIndex > parseInt(this.canvas.height * 0.8)) {
                    ...
                    this.ctx.putImageData(img, parseInt(this.canvas.width * 0.1), parseInt(this.canvas.height*0.1));
                    this.allData.shift();
					// 清除Y坐标数值，重新绘制数据

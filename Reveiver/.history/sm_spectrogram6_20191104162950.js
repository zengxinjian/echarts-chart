    ...
    _.prototype.drawData=function(data){
        ...
        if (this.axis ==="Horizontal") {
            ...
            if(drawData.length > (this.canvas.width * 0.8)){
                ...
                for (var i = 0; i < this.canvas.height*0.8; i++) {
                    this.ctx.putImageData(drawData[parseInt(i*dataInCoorSpace)], this.canvas.height*0.1+i, this.canvas.width*0.1+this.drawIndex>this.canvas.width*0.9?parseInt(this.canvas.width*0.9)-1:parseInt(this.canvas.width*0.1)+this.drawIndex);
                }

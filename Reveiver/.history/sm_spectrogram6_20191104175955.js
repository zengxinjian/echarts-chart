var sm_spectrogram=(function(){
    ...
    _.prototype.drawHTick=function(){
        ...
        if(this.axis ==="Horizontal"){
            ...
            this.ctx.fillText("单位:Hz", this.canvas.width * 0.1, this.canvas.height * 0.1 + 25)
        }else{
    ...
    _.prototype.drawVTick=function(){
        ...
        if(this.axis ==="Horizontal"){
            for (var i = 0; i <= parseInt(oldWidth); i++) {
                ...
                this.ctx.strokeStyle = "#ddd";
                this.ctx.font = "14px Arial";
                if (i % parseInt(oldWidth / 10) === 0) { //&& i !== 0
            ...
            this.ctx.fillText("单位:s", this.canvas.width * 0.1 - 5, this.canvas.height * 0.1 + 25)
        }
    ...
    _.prototype.drawData=function(data){
        ...
        if (this.axis ==="Horizontal") {
            ...
            if(drawData.length > (this.canvas.width * 0.8)){
                ...
                console.log(this.canvas.height*0.8)
                for (var i = 0; i < this.canvas.height*0.8; i++) {
                ...
                if (this.drawIndex >= parseInt(this.canvas.width * 0.8)) {
                    ...
                    this.ctx.putImageData(img, parseInt(this.canvas.width * 0.1)-1, parseInt(this.canvas.height*0.1));
                    this.allData.shift();
                    // 清除Y坐标数值，重新绘制数据
                    this.ctx.clearRect(110, this.canvas.height*0.9, this.canvas.width, this.canvas.height * 0.1);
					// this.ctx.clearRect(0,this.canvas.height*0.8, this.canvas.width, 30);
					this.drawVTick();
                }
                this.drawIndex++;
            }
	...
	_.prototype.redraw = function() {
        ...
        if(this.axis ==="Horizontal"){
            this.ctx.clearRect(0, 0, this.canvas.width*0.1, this.canvas.height); //清除画布所有图形
        }else{

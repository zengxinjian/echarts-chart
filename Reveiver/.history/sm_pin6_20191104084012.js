...
var sm_pin = (function() {
    ...
    that.canvas.onmousedown = function (e) {
		...
		that.canvas.onmouseup = function (e) {
			...
			var loc = windowToCanvas(e.clientX, e.clientY);
			const {x , y} = {x:loc.x-100,y: loc.y-80};
			if((x>0 && x<800)&&(y>0 && y<640)){ // (x - mousedown.startX) > 50 限制最小矩形
				console.log("松开操作")
		...
		// 	var clickRightMenu = document.getElementById("clickRightMenu")
		// 	clickRightMenu.style.display = "none"
		// 	flog = true;
		...
		// 	}
		// 	// 是否画出界
		// 	if((startX>100 && startX<900)&&(startY>80 && startY<710)&&(endX>100&&endX<900)&&(endY>80&&endY<720)){
		// 		drawlLine(ev);
		// 	}
		// }, false);
	}
